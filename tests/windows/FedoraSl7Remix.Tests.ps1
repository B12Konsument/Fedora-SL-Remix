...
Describe 'release layout validation' {
    It 'accepts the fixed versioned layout' {
        { Assert-Sl7PersonalizationLayout -Layout (New-Sl7TestLayout) -CustomizerVersion '0.2.4' } | Should -Not -Throw
    }

    It 'rejects the previous Windows customizer version' {
        { Assert-Sl7PersonalizationLayout -Layout (New-Sl7TestLayout) -CustomizerVersion '0.2.3' } | Should -Throw
    }
    ...
    It 'rejects overlapping personalization slots' {
        ...
        { Assert-Sl7PersonalizationLayout -Layout $layout -CustomizerVersion '0.2.4' } | Should -Throw
    }
...
Describe 'UAC handoff' {
    ...
    It 'round-trips every elevation parameter and deletes the handoff' {
        ...
        $hash = New-Sl7ElevationHandoff -Path $handoff -Release 'v0.2.4' -FirmwareSource 'Windows' `
        ...
        $saved.Release | Should -Be 'v0.2.4'
